...
import static com.melihcan.exception.EErrorType.BAD_REQUEST_ERROR;
import static com.melihcan.exception.EErrorType.INTERNAL_ERROR;
...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleSpringMonoException(OrganizationException exception){
